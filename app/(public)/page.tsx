...
export default function Home() {
    return (
        <main>
            <div
                className="min-h-[calc(100vh-80px)] flex items-end justify-start px-4 sm:px-8 lg:px-10 py-12 sm:py-16 lg:py-20 bg-cover bg-center"
            ...
            >
                <div className="text-white flex text-start flex-col max-w-2xl gap-4 sm:gap-6">
                    <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-bold leading-tight">
                        Qurban Lebih Mudah dan Terpercaya
                    </h2>
                    <p className="text-base sm:text-xl lg:text-2xl">
                        Qurban Story telah berpengalaman lebih dari 10 tahun dalam
                        pengelolaan dan penyaluran hewan qurban.
                    </p>
            ...
            <div className="bg-secondary flex flex-col items-center justify-center gap-4 sm:gap-6 px-4 sm:px-8 lg:px-10 py-14 sm:py-20 text-center">
                ...
                <p className="max-w-5xl text-base sm:text-lg lg:text-xl font-medium">
                    Qurban Story bergerak di bidang peternakan dan pengelolaan qurban.
                    Dengan pengalaman lebih dari satu dekade, kami telah melayani ribuan
                    pelanggan di berbagai daerah. Kami berfokus pada kemudahan transaksi
                    dan pelaporan yang jelas, sehingga setiap pequrban dapat memantau
                    proses pelaksanaan qurban dengan tenang dan percaya.
                </p>
            </div>
            ...
            <div className="bg-primary flex flex-col items-center justify-center gap-8 px-4 sm:px-8 lg:px-10 py-14 sm:py-20 text-center">
                <div className="text-white flex w-full max-w-7xl flex-col items-center gap-4 sm:gap-6">
                    ...
                    <p className="max-w-5xl text-base sm:text-lg lg:text-xl font-medium">
                        Alasan pelanggan memercayakan qurban mereka kepada kami.
                    </p>
...
Tanpa proses yang rumit."
            ...
            <div className="bg-secondary flex flex-col items-center justify-center gap-8 px-4 sm:px-8 lg:px-10 py-14 sm:py-20 text-center">
                <div className="text-black flex flex-col items-center gap-3 sm:gap-4 lg:gap-6">
                    ...
                    <h4 className="text-base sm:text-lg lg:text-xl font-medium">
                        Tiga langkah sederhana untuk menunaikan qurban bersama Qurban Story
                    </h4>
                </div>
                <div className="grid w-full max-w-6xl grid-cols-1 justify-items-center gap-4 sm:gap-6 lg:grid-cols-3 lg:gap-8">
                    <AlurCard
                        ...
                        description="Pilih hewan qurban yang Anda inginkan dari berbagai pilihan yang tersedia."
                    />
                    <AlurCard
                        number="02"
                        title="Lakukan Pembayaran"
                        description="Lakukan pembayaran secara aman melalui berbagai metode yang tersedia."
                    />
                    <AlurCard
                        number="03"
            ...
            <div className="bg-secondary flex flex-col justify-center items-center text-center gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-8 lg:px-30 py-14 sm:py-20">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold max-w-4xl">
                    Siap Menunaikan Qurban dengan Lebih Tenang?
                </h2>
                <h4 className="text-base sm:text-lg lg:text-xl font-medium max-w-4xl">
                    Percayakan Qurban Anda kepada Kami. Proses mudah, laporan jelas.
                </h4>
                <Link href="/produk">
