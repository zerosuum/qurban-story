            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              <label className="block cursor-pointer overflow-hidden rounded-xl border border-dashed border-neutral-200 bg-neutral-50">
                ...
                <div className="flex h-36 flex-col items-center justify-center gap-2 text-neutral-400">
                  ...
                  <span className="text-sm font-medium text-neutral-500">
                    Unggah foto produk (bisa lebih dari satu)
                  </span>
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  onChange={(event) =>
                    handleFieldChange("namaProduk", event.target.value)
                  }
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                <div className="flex flex-col gap-2">
                  ...
                  <select
                    ...
                    value={form.tipe}
                    onChange={(event) =>
                      handleFieldChange("tipe", event.target.value)
                    }
                    className="h-10 w-full rounded-xl border border-neutral-100 px-3 text-sm text-neutral-500 outline-none focus:border-primary-500"
                    required
                  >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    value={form.berat}
                    onChange={(event) =>
                      handleFieldChange("berat", event.target.value)
                    }
                    placeholder="30 KG"
                    className="h-10 w-full rounded-xl border border-neutral-100 px-3 text-sm text-neutral-500 outline-none focus:border-primary-500"
                    required
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    value={form.stok}
                    onChange={(event) =>
                      handleFieldChange("stok", event.target.value)
                    }
                    placeholder="12"
                    className="h-10 w-full rounded-xl border border-neutral-100 px-3 text-sm text-neutral-500 outline-none focus:border-primary-500"
                    required
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      handleFieldChange(
                        "diskon",
                        formatDiscountPercentInput(event.target.value),
                      )
                    }
                    placeholder="10%"
                    className="h-10 w-full rounded-xl border border-neutral-100 px-3 text-sm text-neutral-500 outline-none focus:border-primary-500"
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  onChange={(event) =>
                    handleFieldChange("deskripsi", event.target.value)
                  }
